...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}html{min-width:320px;min-height:100%;background:var(--bg-a)}
    ...
    main{width:min(430px,100%);border:1px solid var(--line);border-radius:var(--radius);background:var(--panel);padding:30px;box-shadow:var(--shadow);-webkit-backdrop-filter:blur(34px) saturate(150%);backdrop-filter:blur(34px) saturate(150%);animation:enter 240ms var(--curve) both}
    ...
    input{width:100%;min-height:46px;border:1px solid var(--line-strong);border-radius:var(--control-radius);background:var(--panel-strong);padding:12px 14px;color:var(--text);font:inherit;letter-spacing:0;outline:none;box-shadow:0 1px 2px rgba(35,65,98,.06),inset 0 1px 0 var(--highlight);transition:border-color var(--motion) ease,box-shadow var(--motion) ease,background var(--motion) ease}
    input:hover{border-color:rgba(10,132,255,.3)}input:focus{border-color:var(--accent);box-shadow:0 0 0 4px rgba(10,132,255,.14),inset 0 1px 0 var(--highlight);background:var(--panel-strong)}
    ...
    @media(max-width:480px){body{padding:16px}main{border-radius:24px;padding:24px 20px}}
  </style>
</head>
<body>
  <main>
