...
keys = {
    ...
    'SEAT_ASSISTANT_ENABLED', 'SEAT_ASSISTANT_PROVIDER', 'SEAT_ASSISTANT_AREA_ID',
    'SEAT_ASSISTANT_MIN_REQUEST_INTERVAL_SECONDS', 'SEAT_ASSISTANT_PAIRING_ORIGIN',
    'SEAT_ASSISTANT_EXTENSION_ORIGIN',
}
values = {}
